...
Ext.ux.tree.TreeGridNodeUI = Ext.extend(Ext.tree.TreeNodeUI, {
    ...
    renderElements : function(n, a, targetNode, bulkRender){
        ...
        for(i = 1, len = cols.length; i < len; i++){
            c = cols[i];
            buf.push(
                    '<td class="x-treegrid-col ', (c.cls ? c.cls : ''), '"', (c.align ? ' style="text-align: ' + c.align + ';"' : ''), '>',
                        '<div unselectable="on" class="', c.buttons ? 'x-treegrid-button' : 'x-treegrid-text', '">',
