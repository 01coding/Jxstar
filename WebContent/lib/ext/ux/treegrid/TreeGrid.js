                ...
                '<div class="x-grid3-header">',
                    '<div class="x-treegrid-header-inner">',
                        '<div class="x-grid3-header-offset">',
                            ...
                            '<tpl for="columns">',
                            '<td class="x-grid3-hd x-grid3-cell x-treegrid-hd" style="text-align: {align}; {hcss}" id="', this.id, '-xlhd-{#}">',
    ...
    initColumns: function() {
        ...
        for (i = 0; i < len; i++) {
            ...
            if (!c.isColumn) {
                ...
                //------------------ 构建操作功能
                if (c.buttons) {
					var hasHandler = !!c.buttonHandler;//如果有此对象，则不做特殊处理
