	...
	var items = [{
		...
		items:[{
			...
			items:[{
				...
				layout:'form',
				items:[
					{xtype:'textfield', fieldLabel:'任务名称', name:'task_base__task_name', allowBlank:false, labelStyle:'color:#0077FF;', labelSeparator:'*', anchor:'100%', maxLength:50},
					{xtype:'textfield', fieldLabel:'后台类', name:'task_base__task_class', allowBlank:false, labelStyle:'color:#0077FF;', labelSeparator:'*', anchor:'100%', maxLength:100},
					{xtype:'datefield', fieldLabel:'上次运行时间', name:'task_base__run_date', defaultval:'fun_getToday()', format:'Y-m-d H:i:s', allowBlank:false, labelStyle:'color:#0077FF;', labelSeparator:'*', anchor:'100%'},
				...
				items:[
					...
					{xtype:'textfield', fieldLabel:'执行计划', name:'task_base__task_plan', allowBlank:false, labelStyle:'color:#0077FF;', labelSeparator:'*', readOnly:true, anchor:'100%', maxLength:50},
			...
			items:[{
				...
				layout:'form',
				items:[
					{xtype:'textarea', fieldLabel:'任务描述', name:'task_base__task_memo', anchor:'100%', height:120, maxLength:200}
				]
			}
			]
		}]
					...
					items: [
						{
							...
							items: [
								...
								{xtype:'textfield',    name:'day_time', value:'00:00', vtype:'time24', width:60}
							]
						},{
							xtype:'compositefield',
							items: [
								...
								{xtype:'combo',    name:'week_day', width:100, 
									store: new Ext.data.SimpleStore({
										fields:['value','text'],
										data: weekdays
									}),
								...
								{xtype:'textfield',    name:'week_time', value:'00:00', width:60}
							]
						},{
							xtype:'compositefield',
							items: [
								...
								{xtype:'displayfield', value:jx.sys.time},	//'，时间是'
								{xtype:'textfield',    name:'month_time', value:'00:00', width:60}
							]
						},{
							xtype:'compositefield',
							items: [
								...
								{xtype:'combo',    name:'monthw_week', width:100,
									store: new Ext.data.SimpleStore({
										fields:['value','text'],
										data: weeknums
									}),
								...
								{xtype:'combo',    name:'monthw_day', width:100,
									store: new Ext.data.SimpleStore({
										fields:['value','text'],
										data: weekdays
									}),
									...
									value: weekdays[0][0]},
								{xtype:'displayfield', value:jx.sys.time},	//'，时间是'
								{xtype:'textfield',    name:'monthw_time', value:'00:00', width:60}
							]
						},{
							xtype:'compositefield',
							items: [
								...
								{xtype:'combo',    name:'year_month', width:100,
									store: new Ext.data.SimpleStore({
										fields:['value','text'],
										data: monthnums
									}),
								...
								{xtype:'displayfield', value:jx.sys.time},	//'，时间是'
								{xtype:'textfield',    name:'year_time', value:'00:00', width:60}
							]
						},{
							xtype:'compositefield',
							items: [
								...
								{xtype:'combo',    name:'yearw_week', width:100,
									store: new Ext.data.SimpleStore({
										fields:['value','text'],
										data: weeknums
									}),
									...
									value: weeknums[0][0]},
								{xtype:'displayfield', value:jx.sys.date},	//'，日期是'
								{xtype:'combo',    name:'yearw_day', width:100,
									store: new Ext.data.SimpleStore({
										fields:['value','text'],
										data: weekdays
									}),
									...
									value: weekdays[0][0]},
								{xtype:'displayfield', value:jx.sys.time},	//'，时间是'
								{xtype:'textfield',    name:'yearw_time', value:'00:00', width:60}
							]
						}
					]
				},{
