Jxstar.currentPage = function() {
	...
	var cols = [
	{col:{header:'任务摘要', width:247, sortable:true}, field:{name:'wf_instance__instance_title',type:'string'}},
	{col:{header:'开始时间', width:182, sortable:true, align:'center',
		renderer:function(value) {
			return JxUtil.renderDate(value, 'Y-m-d');
		}}, field:{name:'wf_instance__start_date',type:'date'}},
	{col:{header:'发起人', width:100, sortable:true}, field:{name:'wf_instance__start_user',type:'string'}},
	...
	{col:{header:'结束时间', width:100, sortable:true, hidden:true, align:'center',
		renderer:function(value) {
			return JxUtil.renderDate(value, 'Y-m-d');
		}}, field:{name:'wf_instance__end_date',type:'date'}},
	{col:{header:'实例消息', width:100, sortable:true, hidden:true}, field:{name:'wf_instance__instance_desc',type:'string'}},
	{col:{header:'任务名称', width:159, sortable:true}, field:{name:'wf_instance__process_name',type:'string'}},
	{col:{header:'功能ID', width:100, sortable:true, colindex:10000, hidden:true}, field:{name:'wf_instance__fun_id',type:'string'}},
	{col:{header:'发起人ID', width:100, sortable:true, colindex:10000, hidden:true}, field:{name:'wf_instance__start_userid',type:'string'}},
	{col:{header:'父过程ID', width:100, sortable:true, colindex:10000, hidden:true}, field:{name:'wf_instance__parent_pid',type:'string'}},
	{col:{header:'父实例ID', width:100, sortable:true, colindex:10000, hidden:true}, field:{name:'wf_instance__parent_sid',type:'string'}},
	...
	{col:{header:'数据ID', width:100, sortable:true, colindex:10000, hidden:true}, field:{name:'wf_instance__data_id',type:'string'}},
	{col:{header:'主键', width:100, sortable:true, colindex:10000, hidden:true}, field:{name:'wf_instance__instance_id',type:'string'}}
	];
