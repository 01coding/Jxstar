Jxstar.currentPage = function() {
	...
	var cols = [
	{col:{header:'*统计方案', width:157, sortable:true, editable:true, hcss:'color:#0077FF;',
		editor:new Ext.form.TextField({
			maxLength:50, allowBlank:false
		})}, field:{name:'sys_stat__stat_name',type:'string'}},
	{col:{header:'共享?', width:49, sortable:true, hidden:true, defaultval:'0'}, field:{name:'sys_stat__is_share',type:'string'}},
	{col:{header:'创建人', width:79, sortable:true, hidden:true}, field:{name:'sys_stat__user_name',type:'string'}},
