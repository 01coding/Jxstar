	...
	var items = [{
		...
		items:[{
			...
			items:[{
				...
				layout:'form',
				items:[
					{xtype:'combo', fieldLabel:'出差类型', name:'oa_apply__app_type', defaultval:'0',
					...
					{xtype:'textfield', fieldLabel:'出差地点', name:'oa_apply__app_addr', allowBlank:false, labelStyle:'color:#0077FF;', labelSeparator:'*', anchor:'100%', maxLength:50},
					...
					{xtype:'hidden', fieldLabel:'业务类型', name:'oa_apply__bus_type', defaultval:'cc', anchor:'100%'},
				...
				items:[
					...
					{xtype:'numberfield', fieldLabel:'预算(元)', name:'oa_apply__app_money', anchor:'100%', maxLength:22},
			...
			items:[{
				...
				layout:'form',
				items:[
					{xtype:'textarea', fieldLabel:'出差事由', name:'oa_apply__app_desc', allowBlank:false, labelStyle:'color:#0077FF;', labelSeparator:'*', anchor:'100%', height:90, maxLength:500}
				]
			}
			]
		}]
