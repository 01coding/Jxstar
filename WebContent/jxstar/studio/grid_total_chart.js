Jxstar.currentPage = function() {
	...
	{col:{header:'*所属功能', width:192, sortable:true, editable:true, hcss:'color:#0077FF;',
		editor:new Ext.form.ComboBox({
			maxLength:100, name:'rpt_list__fun_id', 
			editable:true, hcss:'color:#0077FF;', allowBlank:false,
			triggerClass:'x-form-search-trigger', 
			listeners:{afterrender: function(combo) {
				JxSelect.initCombo('total_chart', combo, 'node_total_chart_editgrid');
			}}
		})}, field:{name:'rpt_list__fun_id',type:'string'}},
	{col:{header:'*所属模块', width:184, sortable:true, editable:true, hcss:'color:#0077FF;',
		editor:new Ext.form.TextField({
			maxLength:25, allowBlank:false
		})}, field:{name:'rpt_list__module_id',type:'string'}},
	{col:{header:'报表样式', width:79, sortable:true, hidden:true, defaultval:'total3', align:'center',
		editable:false,
		editor:new Ext.form.ComboBox({
