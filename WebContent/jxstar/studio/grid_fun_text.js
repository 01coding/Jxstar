Jxstar.currentPage = function() {
	...
	{col:{header:'*文字描述', width:312, sortable:true, editable:true, hcss:'color:#0077FF;',
		editor:new Ext.form.TextField({
	...
	{col:{header:'英文描述', width:413, sortable:true, editable:true, hcss:'color:#2E6DA4;',
		editor:new Ext.form.TextField({
			maxLength:500
		})}, field:{name:'funall_text__prop_value_en',type:'string'}},
	{col:{header:'T1描述', width:244, sortable:true, editable:true, hcss:'color:#2E6DA4;',
		editor:new Ext.form.TextField({
			maxLength:200
	...
	{col:{header:'来源', width:100, sortable:true, hidden:true, defaultval:'0', align:'center',
		editable:true, hcss:'color:#2E6DA4;',
		editor:new Ext.form.ComboBox({
			store: new Ext.data.SimpleStore({
				fields:['value','text'],
