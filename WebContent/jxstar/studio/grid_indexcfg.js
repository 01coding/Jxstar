Jxstar.currentPage = function() {
	...
	var cols = [
	{col:{header:'状态', width:67, sortable:true, defaultval:'1', align:'center',
		editable:false,
	...
	{col:{header:'*索引名称', width:172, sortable:true, editable:true, hcss:'color:#0077FF;',
		editor:new Ext.form.TextField({
			maxLength:30, allowBlank:false
		})}, field:{name:'dm_indexcfg__index_name',type:'string'}},
	{col:{header:'*相关字段', width:219, sortable:true, editable:true, hcss:'color:#0077FF;',
		editor:new Ext.form.TextField({
			maxLength:100, allowBlank:false
		})}, field:{name:'dm_indexcfg__index_field',type:'string'}},
	{col:{header:'唯一?', width:51, sortable:true, defaultval:'0', align:'center',
	...
	{col:{header:'索引说明', width:271, sortable:true, editable:true, hcss:'color:#2E6DA4;',
		editor:new Ext.form.TextField({
			maxLength:200
