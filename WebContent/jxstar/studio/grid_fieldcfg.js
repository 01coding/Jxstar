Jxstar.currentPage = function() {
	...
	var cols = [
	{col:{header:'状态', width:65, sortable:true, defaultval:'1', align:'center',
		editable:false,
	...
	{col:{header:'*字段名称', width:122, sortable:true, editable:true, hcss:'color:#0077FF;',
		editor:new Ext.form.TextField({
			maxLength:30, allowBlank:false
		})}, field:{name:'dm_fieldcfg__field_name',type:'string'}},
	{col:{header:'*字段标题', width:134, sortable:true, editable:true, hcss:'color:#0077FF;',
		editor:new Ext.form.TextField({
			maxLength:50, allowBlank:false
		})}, field:{name:'dm_fieldcfg__field_title',type:'string'}},
	{col:{header:'*数据类型', width:100, sortable:true, defaultval:'varchar', align:'center',
		editable:true, hcss:'color:#0077FF;',
		editor:new Ext.form.ComboBox({
			store: new Ext.data.SimpleStore({
				fields:['value','text'],
	...
	{col:{header:'长度', width:55, sortable:true, defaultval:'50', align:'right',
		editable:true, hcss:'color:#2E6DA4;',
		editor:new Ext.form.NumberField({
			decimalPrecision:0, maxLength:22
		}),renderer:JxUtil.formatInt()}, field:{name:'dm_fieldcfg__data_size',type:'int'}},
	{col:{header:'小数位', width:67, sortable:true, align:'right',
		editable:true, hcss:'color:#2E6DA4;',
		editor:new Ext.form.NumberField({
			decimalPrecision:0, maxLength:22
	...
	{col:{header:'缺省值', width:71, sortable:true, editable:true, hcss:'color:#2E6DA4;',
		editor:new Ext.form.TextField({
			maxLength:20
	...
	{col:{header:'分类', width:67, sortable:true, defaultval:'0', align:'center',
		editable:true, hcss:'color:#2E6DA4;',
		editor:new Ext.form.ComboBox({
			store: new Ext.data.SimpleStore({
				fields:['value','text'],
	...
	{col:{header:'字段说明', width:255, sortable:true, editable:true, hcss:'color:#2E6DA4;',
		editor:new Ext.form.TextField({
			maxLength:1000
